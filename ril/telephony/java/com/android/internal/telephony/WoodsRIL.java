...
public class WoodsRIL extends RIL implements CommandsInterface {
...
static int registered = 0;
    ...
    public WoodsRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
    }

    public WoodsRIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
